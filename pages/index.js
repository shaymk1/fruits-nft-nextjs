...
export default function Home() {
	return (
		<div className="min-h-screen h-full w-full flex flex-col bg-[#f0e9e9] overflow-hidden">
			<header className="min-w-full text-gray-400 py-14 px-4 md:px-0">
				<div className="flex container items-center justify-between mx-auto max-w-5xl h-full">
					{/* logo */}
					<Link href="">
						<a className="font-coiny text-xl md:3xl font-bold text-rose-500">
							The
							<span className="text-[#00bbf9] ">Fruit</span>
							Club .
						</a>
					</Link>
					...
					<div className="flex flex-col md:flex-row md:space-x-16 space-y-10 items-center mt-20 w-full">
						...
						<div className="flex flex-col md:items-start items-center justify-center text-center font-coiny text-gray-800 px-4 md:px-0 py-10 mt-14">
							...
							<p className="mt-6 text-lg">
								{`The Fruit Club are a collection of 5,555 burning hot NFTs living in
                the core of the blockchain. Each individual Fruit Club is
                carefully curated from over 150 traits, along with some
                incredibly rare 1/1s that have traits that can't be found from
                any other Fruit Club. Our vision is to create an amazing project
